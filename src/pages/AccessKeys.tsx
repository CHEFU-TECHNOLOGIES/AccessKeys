        ...
        <div className="px-6 lg:px-8 py-8 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-sm text-zinc-500 mt-1">Manage credentials that provide access to Flow Mail.</p>
                </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                {paginated.length === 0 ? (
                    <EmptyState
                        ...
                        description={search || statusFilter !== 'all' ? 'No keys match your current filters.' : 'Create your first credential to give an employee or workspace secure access to Flow Mail.'}
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex flex-wrap gap-1 max-w-45">
                                                    <span className="text-xs text-zinc-500 bg-zinc-800 px-1.5 py-0.5 rounded font-medium whitespace-nowrap">
